...
import com.android.internal.util.cyanide.ConfigSplitHelper;
...
public class PowerMenuHelper {
    ...
    private static Drawable getPowerMenuSystemIcon(Context context, String clickAction) {
        ...
        } else if (clickAction.equals(PowerMenuConstants.ACTION_PA_PIE)) {
            return res.getDrawable(
        ...
        } else if (clickAction.equals(PowerMenuConstants.ACTION_SETTINGS)) {
            return res.getDrawable(
                com.android.internal.R.drawable.ic_settings);
        } else if (clickAction.equals(PowerMenuConstants.ACTION_LOCKDOWN)) {
            return res.getDrawable(
        ...
        } else if (clickAction.equals(PowerMenuConstants.ACTION_PROFILE)) {
            return res.getDrawable(
        ...
        } else if (clickAction.equals(PowerMenuConstants.ACTION_HWKEYS)) {
            return res.getDrawable(
                com.android.internal.R.drawable.ic_lock_buttons);
        } else if (clickAction.equals(PowerMenuConstants.ACTION_HEADS_UP)) {
            return res.getDrawable(
                com.android.internal.R.drawable.ic_lock_heads_up);
        } else if (clickAction.equals(PowerMenuConstants.ACTION_AMBIENT_DISPLAY)) {
            return res.getDrawable(
