...
public final class Settings {
	...
	/**
       ...
       public static final String USB_DATA_AUTO_UNLOCK = "usb_data_auto_unlock";
        ...
        /**
         * Setting for clock color on light status bar
         * @hide
         */
        public static final String STATUS_BAR_CLOCK_COLOR_DARK_MODE = "status_bar_clock_color_dark_mode";
		 ...
		 * @hide
		 */
		public static final String STATUS_BAR_CYANIDE_LOGO_SHOW_ON_LOCK_SCREEN = "status_bar_cyanide_logo_show_on_lock_screen";
	...
	/**
        ...
        /**
         * Color of the quick settings header ripple effect
         * @hide
         */
        public static final String QS_HEADER_RIPPLE_COLOR = "qs_header_ripple_color";

        /**
         * Color of the quick settings header icons
         * @hide
         */
        public static final String QS_HEADER_ICON_COLOR = "qs_header_icon_color";

        /**
         * Color of the quick settings header text color
         * @hide
         */
        ...
        /**
         * Color of the clear all button ripple
         * @hide
         */
