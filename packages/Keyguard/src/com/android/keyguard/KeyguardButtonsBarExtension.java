...
public class KeyguardButtonsBarExtension extends LinearLayout {
    ...
    public KeyguardButtonsBarExtension(Context context) {
        this(context, null);
    }

    public KeyguardButtonsBarExtension(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void createBarButtons() {
        ArrayList<ActionConfig> actionConfigs = ActionHelper.getLockscreenButtonBarExtensionConfig(mContext);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LOCK_SCREEN_BUTTONS_BAR_EXTENSION_HIDE_BAR),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LOCK_SCREEN_BUTTONS_BAR_EXTENSION_NUMBER_OF_NOTIFICATIONS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
