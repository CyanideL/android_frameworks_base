...
package com.android.systemui.cyanide.expansionview.panels;
...
public class ExpansionViewCustomPanel extends RelativeLayout {
    ...
    public void changeView(boolean animate) {
        ...
        if (weatherVisible) {
            mWeatherPanel.setListening(true);
        } else {
            mWeatherPanel.setListening(false);
        }
        if (activityVisible) {
            mActivityPanel.setListening(true);
        } else {
            mActivityPanel.setListening(false);
        }
    ...
    public void setStroke() {
        final int mStroke = Settings.System.getInt(
                mResolver, Settings.System.EXPANSION_VIEW_STROKE, 0);
        final int mStrokeColor = Settings.System.getInt(
                mResolver, Settings.System.EXPANSION_VIEW_STROKE_COLOR, 0xff1976D2);
        ...
        final int mCornerRadius = Settings.System.getInt(
                mResolver, Settings.System.EXPANSION_VIEW_CORNER_RADIUS, 8);
        ...
        final int mCustomDashGap = Settings.System.getInt(
                mResolver, Settings.System.EXPANSION_VIEW_STROKE_DASH_WIDTH, 0);
