...
import com.android.systemui.cyanide.NetworkTrafficController.Traffic;
import com.android.systemui.R;

public class NetworkTraffic extends AlphaOptimizedLinearLayout implements
    ...
    private int mTxtSizeSingle;
    private int mTxtSizeDual;
    ...
    public void onDensityOrFontScaleChanged() {
        mTxtSizeSingle = mResources.getDimensionPixelSize(R.dimen.network_traffic_single_text_size);
        mTxtSizeDual = mResources.getDimensionPixelSize(R.dimen.network_traffic_dual_text_size);
        int textMarginEnd = mResources.getDimensionPixelSize(R.dimen.network_traffic_text_end_margin);

        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mTextView.getLayoutParams();
        lp.setMarginEnd(textMarginEnd);
