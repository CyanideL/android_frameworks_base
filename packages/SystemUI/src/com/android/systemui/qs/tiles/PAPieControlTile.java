...
public class PAPieControlTile extends QSTile<QSTile.BooleanState> {
    private boolean mListening;
    private PAPieControlObserver mObserver;

    public PAPieControlTile(Host host) {
        super(host);
        mObserver = new PAPieControlObserver(mHandler);
    }
 ...
 protected void toggleState() {
         Settings.System.putInt(mContext.getContentResolver(),
                        Settings.System.PA_PIE_STATE, !papiecontrolEnabled() ? 1 : 0);
    }
    ...
    private boolean papiecontrolEnabled() {
    ...
    private class PAPieControlObserver extends ContentObserver {
        public PAPieControlObserver(Handler handler) {
            super(handler);
        }
