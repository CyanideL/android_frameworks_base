...
import com.android.systemui.statusbar.phone.HaloTicker;

public class Halo extends FrameLayout implements HaloTicker.TickerCallback {
    ...
    private int mHaloColor = 0xffbbbbbb;
    ...
    public Halo(Context context, AttributeSet attrs, int defStyle) {
        ...
        mHaloColor = Settings.System.getInt(resolver, Settings.Secure.HALO_COLOR, 0xffbbbbbb);
    ...
    public void setStatusBar(BaseStatusBar bar) {
        ...
        if (mBar.getHaloTicker() != null) mBar.getHaloTicker().setUpdateEvent(this);
    ...
    public void cleanUp() {
        ...
        // Kill callback
        mBar.getHaloTicker().setUpdateEvent(null);
        // Flag tasker
